import require$$3$1, { app as app$1, nativeImage, BrowserWindow } from "electron";
...
const appIcon = nativeImage.createFromPath(path$1.join(process.env.VITE_PUBLIC, "icon.png"));
